...
<html lang="en">
  <head>
    ...
    <title>Inenga-Mènè - Inscription</title>
      ...
      <form class="form-type-material" action="/register" method="post">
        ...
        <div class="form-group">
          <label class="custom-control custom-checkbox">
            ...
            <span class="custom-control-description">J'accepte toutes les <a class="text-primary" href="#">conditions</a></span>
          </label>
        </div>

        <br>
        <button class="btn btn-bold btn-block btn-primary" type="submit">Valider</button>
      </form>

      <hr class="w-30">

      <p class="text-center text-muted fs-13 mt-20">Vous avez déjà un compte? <a href="#loginModal">Se connecter</a></p>
    </div>
